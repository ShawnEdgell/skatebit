...
<section>
	...
	<section>
		...
		<p>
			...
			managing and installing all Skater XL script mods. You will need to log in to Nexus Mods to
			download the file.
		</p>
		<aside class="alert variant-filled-warning mb-4">
			<div class="flex items-center">
				...
				<p class="text-base font-semibold my-0 lg:text-lg pr-2">
					The latest UnityModManager has been updated to work with any version of Skater XL. Make
	...
	<section>
		...
		<p>
			After downloading, unzip the file, open the folder, and run
			<strong>UnityModManager.exe.</strong>
		</p>
		<p>
	...
	<section>
		...
		<p>
			...
			<a href="/mods">Mods</a> tab for a list of functional mods.
		</p>
	</section>
	...
	<section>
		...
		<p>
			...
			not working and will need to be updated or removed.
		</p>
	</section>
</section>
