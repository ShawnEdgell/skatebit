...
<!-- 🐥 Mascot -->
<div
	class="fixed bottom-0 left-10 z-10"
	on:mouseenter={() => (isHovered = true)}
	on:mouseleave={() => (isHovered = false)}
	role="presentation"
>
	<!-- Hover zone -->
	<div class="absolute -top-20 -left-10 h-80 w-80"></div>
	...
	>
		<svg bind:this={svgEl} viewBox="0 0 240 200" width="120" height="100">
			<!-- Head -->
			<circle cx="120" cy="100" r="80" class="text-warning fill-current" />
