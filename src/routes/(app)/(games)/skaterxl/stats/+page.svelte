				...
				<aside class="alert variant-ghost-error mb-6">
					...
					<div class="alert-message">
						...
						<p>
							...
							each file so users will understand their purpose. You can also include a text file if
							you think it might provide helpful additional information. Remember, you can always
							edit or delete your stat uploads.
						</p>
					</div>
				</aside>
